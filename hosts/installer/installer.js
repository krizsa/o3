...
var installer = {
    ...
    run: function(all_usr) {
        ...
        //O3/onedit-guid/np-onedit-guid.dll
			...
			//settings = o3tmpdir.get("settings.html"),
			settingsdir = o3tmpdir.get("settings"),
			//settingsimpl = o3tmpdir.get("settings_impl.html"),
			//approve = o3tmpdir.get("approve.html"),
			fftmpdir = instDir.get("o3"),
			ffexttmp = instDir.get("tmp.xpi"),
			//lnkmaker = instDir.get("lnkmaker.vbs"),
		...
		//rsc.get("lnkmaker.vbs", lnkmaker);
		//rsc.get("o3.js", o3js);
		
		settingsdir.createDir();
		
		var unzip = o3.unzip();
		unzip.unzipTo(ffexttmp,fftmpdir);
		//var overlayFile = fftmpdir.get("content/overlay.js"),
		//	overlayBlob = overlayFile.blob;
		//overlayBlob.replace("O3_TMP_FOLDER", o3tmpdir.fullPath);
		//overlayFile.blob = 	overlayBlob;	
		
		//var lnkblob = lnkmaker.blob;
		//lnkblob.replace("O3_TMP_FOLDER", o3tmpdir.fullPath);
		//lnkmaker.blob = lnkblob;	
